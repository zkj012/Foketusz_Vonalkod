...
/* További teendők
Robi:
    Login: timeout kezelés, 4-5 retry kellhet néha; ez nem lenne rossz, ha meglenne
    loggedonuser: elérhető később is
    lekérdezések, írások hibakezelése
    savechanges: tudtam úgy duplán kattintani, hogy  még egyszer megpróbálta elmenteni (Kotorra is jellemző, hogy –elsősorban beolvasáskor –pl. bejelentkezés- hajlandó duplán reagálni)
...
namespace Vonalkod
{
    public partial class VonalkodBeolvasas : Form
    {
        ...
        private void VonalkodBeolvasas_Load(object sender, EventArgs e)
        {
            ...
            {
                vktart = (from v in ke.VonalkodTartomany_t orderby v.Eleje
